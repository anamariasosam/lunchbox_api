...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post order_statuses_url, params: { order_status: { description: @order_status.description } }, as: :json
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { description: @order_status.description } }, as: :json
    assert_response 200
  end
